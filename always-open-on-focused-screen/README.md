...
```bash
sed -i 's/ConfigModule/Library/g' ~/.local/share/kwin/scripts/alwaysopenfocusedscreen/metadata.json
mkdir -p ~/.local/share/kservices5/
ln -sf ~/.local/share/kwin/scripts/alwaysopenfocusedscreen/metadata.json ~/.local/share/kservices5/alwaysopenfocusedscreen.json
